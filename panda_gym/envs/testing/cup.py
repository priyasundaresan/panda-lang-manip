...
class Manipulate(Task):
    ...
    def _create_scene(self) -> None:
        ...
        #self.sim.loadURDF(body_name='cap1', fileName='assets/cap.urdf', basePosition=[0.2,0.0,0.075], globalScaling=0.5)
        #self.sim.loadURDF(body_name='cap2', fileName='assets/cap.urdf', basePosition=[0,0.0,0.075], globalScaling=0.75)
        #self.sim.loadURDF(body_name='mug', fileName='assets/mug/model.urdf', basePosition=[-0.2,0.0,0.075], globalScaling=0.75)
